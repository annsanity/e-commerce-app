...
public class ReviewServiceImpl implements ReviewService {
    ...
    @Override
    public Review updateReview(Long reviewId, String reviewText, double rating, Long userId) throws ReviewNotFoundException {
        Review review = reviewRepository.findById(reviewId)
                .orElseThrow(() -> new ReviewNotFoundException("Review Not found"));

        if (!review.getUser().getId().equals(userId)) {
            throw new ReviewNotFoundException("You do not have permission to update this review");
        }
    ...
    public void deleteReview(Long reviewId, Long userId) throws ReviewNotFoundException {
        ...
        if (!review.getUser().getId().equals(userId)) {
            throw new ReviewNotFoundException("You do not have permission to delete this review");
        }
