...
import com.ecommerce.projectapp.service.impl.CustomerUserServiceImpl;
...
public class SellerController {
    ...
    private Authentication authenticate(String username) {
        UserDetails userDetails = customerUserServiceImpl.loadUserByUsername("seller_" + username);
    ...
    public ResponseEntity<Seller> createSeller(@RequestBody Seller seller) throws SellerException, MessagingException {
        ...
        String text = "Welcome! Verify your account using this link ";
